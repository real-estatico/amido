...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-black" dir="rtl">
      ...
      <div 
        className="fixed inset-0 bg-no-repeat bg-center opacity-30 pointer-events-none"
        style={{
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center">
            ...
            <div className="flex justify-center space-x-6 space-x-reverse">
              <Link href="#" className="text-white/60 hover:text-white transition-colors">תנאי שימוש</Link>
              <Link href="#" className="text-white/60 hover:text-white transition-colors">מדיניות פרטיות</Link>
              <Link href="#" className="text-white/60 hover:text-white transition-colors">צור קשר</Link>
            </div>
          </div>
        </div>
      </footer>
